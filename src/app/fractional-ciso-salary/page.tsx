...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Fractional CISO Salary UK 2026 | Complete Compensation Guide',
...
export default function FractionalCisoSalaryPage() {
  return (
    <div className="min-h-screen bg-white">
      <WebPageSchema title="Fractional CISO Salary UK 2026 | Day Rates & Compensation Guide" description="Complete guide to fractional CISO salary UK. Day rates, annual equivalents, and factors affecting compensation." url="https://fractional.quest/fractional-ciso-salary" dateModified={new Date('2026-01-07')} />
