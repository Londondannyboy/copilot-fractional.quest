...
export function FractionalExecutiveSearchClient() {
  ...
  return (
    <main>
      <LazyCopilotSidebar instructions={`## PAGE CONTEXT\nPage Type: guide | Topic: Fractional Executive Search | URL: /fractional-executive-search\n\nYou're helping someone understand fractional executive search and part-time C-suite recruitment.\nKey facts: Fractional fees 15-25% | 2-4 weeks to place | 1-3 days/week commitment | 20-40% of full-time cost`} labels={{ title: "Fractional Search Guide", initial: firstName ? `Hi ${firstName}! I can help you understand fractional executive search and find the right approach.` : `Welcome! This guide covers fractional executive search for part-time C-suite placements.` }}>
        {pageContent}
      </LazyCopilotSidebar>
    </main>
  );
