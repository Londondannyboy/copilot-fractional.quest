...
const SERVICES = [
  ...
  { title: 'Go-to-Market Execution', description: 'Launch new products, enter new markets, execute expansion strategies with specialist GTM agency support', icon: '🚀' },
