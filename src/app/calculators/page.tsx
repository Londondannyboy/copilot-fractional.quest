...
export const metadata: Metadata = {
  title: 'Fractional Exec Calculators | Free Tools',
      ...
      <section className="relative bg-gradient-to-br from-purple-900 via-purple-800 to-purple-900 py-20 md:py-32">
        <div className="absolute inset-0 mix-blend-overlay opacity-30">
          <Image
            ...
            alt="Fractional Executive Calculators"
            fill
            priority
            sizes="100vw"
        ...
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          <span className="text-purple-300 mb-4 block text-sm font-semibold uppercase tracking-wider">Free Tools</span>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8">
            {calculators.map((calc) => (
              ...
              >
                <div className={`bg-white rounded-2xl border border-gray-200 p-8 h-full shadow-sm hover:shadow-lg transition-shadow ${calc.comingSoon ? 'opacity-60' : ''}`}>
                  {calc.comingSoon && (
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
              ...
              <Link
                ...
                className="mt-6 inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-purple-800 text-white px-6 py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-purple-900 transition-all"
              >
                Find Your Rate →
              </Link>
            </div>
        ...
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-purple-800 text-white px-6 py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-purple-900 transition-all"
            >
            ...
            <Link
              href="/auth/sign-up"
              className="inline-flex items-center justify-center px-6 py-3 border-2 border-gray-300 rounded-lg font-semibold text-gray-700 hover:border-purple-600 hover:text-purple-600 transition-all"
            >
              Join Beta
            </Link>
          </div>
