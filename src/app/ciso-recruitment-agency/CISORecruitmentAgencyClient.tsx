...
export function CISORecruitmentAgencyClient() {
      ...
      <section className="py-12 sm:py-16 bg-white border-t">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            ...
            <Link href="/fractional-recruitment-agency" className="bg-gray-50 p-4 sm:p-6 rounded-lg border hover:border-gray-800 hover:shadow-md transition-all text-center"><div className="text-2xl sm:text-3xl mb-2">🎯</div><div className="font-medium text-gray-900 text-sm sm:text-base">Fractional Recruitment</div></Link>
          </div>
        </div>
      </section>
  ...
  return (
    <main>
      <LazyCopilotSidebar instructions={`## PAGE CONTEXT\nPage Type: guide | Topic: CISO Recruitment Agencies | URL: /ciso-recruitment-agency\n\nYou're helping someone understand CISO recruitment agencies and how to hire Chief Information Security Officers.\nKey facts: CISO recruiter fees 25-35% | 3-6 weeks for fractional, 10-16 weeks for permanent | Board-level assessment critical`} labels={{ title: "CISO Hiring Guide", initial: firstName ? `Hi ${firstName}! I can help you find the right CISO recruitment agency or candidate.` : `Welcome! This guide covers CISO recruitment agencies and executive security search.` }}>
        {pageContent}
      </LazyCopilotSidebar>
    </main>
  );
