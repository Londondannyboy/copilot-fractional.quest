...
export function InterimExecutiveSearchClient() {
  ...
  return (
    <main>
      <LazyCopilotSidebar instructions={`## PAGE CONTEXT\nPage Type: guide | Topic: Interim Executive Search | URL: /interim-executive-search\n\nYou're helping someone understand interim executive search and temporary C-suite recruitment.\nKey facts: Interim fees 15-25% of contract | 2-4 weeks to place | Full-time 3-12 month engagements | Fast deployment for urgent needs`} labels={{ title: "Interim Search Guide", initial: firstName ? `Hi ${firstName}! I can help you understand interim executive search and find the right approach.` : `Welcome! This guide covers interim executive search for temporary C-suite placements.` }}>
        {pageContent}
      </LazyCopilotSidebar>
    </main>
  );
