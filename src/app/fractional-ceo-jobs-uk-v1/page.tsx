...
export default async function FractionalCeoJobsUkPage() {
  const [stats, companies, jobs, relatedJobs] = await Promise.all([getExecutiveStats(), getFeaturedCompanies(), getExecutiveJobs(), getRelatedJobs()])
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="mb-8 text-center">
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-gray-600 mb-2 block">CEO Salary UK</span>
            <h2 className="text-2xl md:text-3xl font-black text-gray-900">CEO Salary UK Calculator - Fractional Executive Rates</h2>
          </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-gray-900">UK Companies Hiring Fractional CEOs</h2>
              <p className="text-gray-600 mt-2">These UK companies are actively looking for fractional CEO and executive talent</p>
            </div>
            <div className="flex flex-wrap justify-center gap-x-12 gap-y-6">
              {companies.map((company: string, index: number) => (
                <span key={index} className="text-xl md:text-2xl font-light text-gray-400 hover:text-yellow-500 transition-colors cursor-default">
                  {company}
                </span>
              ))}
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <RoleNews category="Executive" title="Latest UK Fractional Executive & CEO News" limit={3} />
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900">Common Questions About Fractional CEO UK & Part-Time Executive Jobs</h2>
            <p className="text-gray-600 mt-4">Answers about <strong>fractional CEO jobs</strong>, <strong>interim executive positions</strong>, and <strong>CEO salary UK</strong> rates</p>
          </div>
