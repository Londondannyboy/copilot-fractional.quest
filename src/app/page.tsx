...
export const metadata: Metadata = {
  ...
  description: 'Find fractional executive jobs in the UK. AI-powered search for CFO, CTO, CMO, COO roles. Day rates £600-£2,000. Browse 200+ live opportunities.',
  openGraph: {
    title: 'Fractional Executive Jobs UK | Fractional Quest',
    description: 'Find fractional executive jobs in the UK. AI-powered search for CFO, CTO, CMO, COO roles.',
