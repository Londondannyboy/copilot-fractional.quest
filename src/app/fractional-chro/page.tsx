  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[50vh] flex items-center overflow-hidden">
        <Image src="https://images.unsplash.com/photo-1521791136064-7986c2920216?w=1920&q=80" alt="What is a Fractional CHRO - Part-time Chief HR Officer" fill priority sizes="100vw" className="object-cover object-center" />
        ...
        <div className="relative z-10 w-full py-16">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">What is a <strong>Fractional CHRO</strong>?</h1>
