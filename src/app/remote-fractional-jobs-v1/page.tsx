...
export const metadata: Metadata = {
  title: 'Remote Fractional Jobs UK 2026 | Work From Home Executive Roles',
...
export default async function RemoteFractionalJobsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <WebPageSchema title="Remote Fractional Jobs | Work From Home Executive Roles 2026" description="Find remote fractional executive jobs you can do from anywhere." url="https://fractional.quest/remote-fractional-jobs" dateModified={lastUpdatedDate} />
