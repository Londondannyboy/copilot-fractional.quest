...
export default async function PartTimeCOOJobsUKPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <WebPageSchema title="Part-Time COO Jobs UK | Fractional Operations Director Roles 2025" description="Find part-time COO and Operations Director jobs across the UK." url="https://fractional.quest/part-time-coo-jobs-uk" dateModified={lastUpdatedDate} />
