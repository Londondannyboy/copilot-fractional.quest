...
const tocItems = [
  { id: 'where-to-find', title: 'Where to Find Fractional CFOs' },
...
export default function HireFractionalCFOClient() {
  return (
    <CopilotProvider>
      <HireFractionalCFOClientInner />
    </CopilotProvider>
  );
}

// Inner component with CopilotKit hooks
function HireFractionalCFOClientInner() {
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 py-24">
              ...
              <div className="max-w-4xl">
                ...
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <Link href="#hiring-process" className="px-8 py-4 border-2 border-white text-white font-bold uppercase tracking-wider hover:bg-white hover:text-emerald-700 transition-colors">See Hiring Process</Link>
                </div>
              </div>
            </div>
          ...
          <section id="cost-comparison" className="py-24 bg-gray-50">
            <div className="max-w-6xl mx-auto px-6 lg:px-8">
              <div className="mb-16 text-center">
                ...
                <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6">Cost Comparison: Fractional vs Full-Time vs Accounting Firm</h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">Understand the total cost of each CFO hiring option for your business.</p>
              </div>
                ...
                <table className="w-full border-collapse bg-white rounded-xl shadow-sm overflow-hidden">
                  <thead>
                    <tr className="bg-emerald-700 text-white">
                      ...
                      <th className="px-6 py-4 text-center font-bold">Fractional CFO</th>
                      <th className="px-6 py-4 text-center font-bold">Full-Time CFO</th>
                      <th className="px-6 py-4 text-center font-bold">Accounting Firm</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200">
                    <tr>
                      <td className="px-6 py-4 font-medium text-gray-900">Annual Cost</td>
                      <td className="px-6 py-4 text-center text-emerald-700 font-bold">£80k - £150k</td>
                      <td className="px-6 py-4 text-center text-gray-600">£180k - £320k</td>
                      <td className="px-6 py-4 text-center text-gray-600">£120k - £300k</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="px-6 py-4 font-medium text-gray-900">Days per Week</td>
                      <td className="px-6 py-4 text-center text-emerald-700">2-3 days</td>
                    ...
                    <tr>
                      ...
                      <td className="px-6 py-4 text-center text-emerald-700">30 days</td>
                    ...
                    <tr>
                      ...
                      <td className="px-6 py-4 text-center text-green-600">Optional (0.25-0.5%)</td>
                      <td className="px-6 py-4 text-center text-red-600">0.5-2%</td>
                      <td className="px-6 py-4 text-center text-green-600">None</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="px-6 py-4 font-medium text-gray-900">Time to Hire</td>
                      <td className="px-6 py-4 text-center text-emerald-700">2-4 weeks</td>
                      <td className="px-6 py-4 text-center text-gray-600">3-6 months</td>
                      <td className="px-6 py-4 text-center text-gray-600">1-2 weeks</td>
                    </tr>
                    <tr>
                      <td className="px-6 py-4 font-medium text-gray-900">Strategic Input</td>
                      <td className="px-6 py-4 text-center text-green-600">High (embedded partner)</td>
                      <td className="px-6 py-4 text-center text-green-600">High</td>
                      <td className="px-6 py-4 text-center text-gray-600">Limited (compliance focus)</td>
                    </tr>
                    <tr className="bg-emerald-100">
                      <td className="px-6 py-4 font-bold text-gray-900">Best For</td>
                      <td className="px-6 py-4 text-center text-emerald-700 font-medium">Scale-ups needing strategic finance</td>
                      <td className="px-6 py-4 text-center text-gray-600 font-medium">Large orgs with complex finance</td>
                      <td className="px-6 py-4 text-center text-gray-600 font-medium">Compliance and reporting only</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <div className="mt-8 text-center">
                <p className="text-gray-600">Sources: <a href="https://www.glassdoor.co.uk" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-800 underline">Glassdoor UK</a>, <a href="https://www.icaew.com" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-800 underline">ICAEW Salary Survey</a>, Market research</p>
              </div>
            </div>
          </section>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li><Link href="/fractional-cfo-salary" className="text-gray-600 hover:text-emerald-700 transition-colors">CFO Salary & Day Rates</Link></li>
                    ...
                    <li><Link href="/interim-cfo-jobs-uk" className="text-gray-600 hover:text-emerald-700 transition-colors">Interim CFO Jobs</Link></li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li><Link href="/hire-fractional-coo" className="text-gray-600 hover:text-emerald-700 transition-colors">Hire a Fractional COO</Link></li>
                    <li><Link href="/hire-fractional-cto" className="text-gray-600 hover:text-emerald-700 transition-colors">Hire a Fractional CTO</Link></li>
                    <li><Link href="/hire-fractional-cmo" className="text-gray-600 hover:text-emerald-700 transition-colors">Hire a Fractional CMO</Link></li>
                    <li><Link href="/hire-fractional-ceo" className="text-gray-600 hover:text-emerald-700 transition-colors">Hire a Fractional CEO</Link></li>
                    <li><Link href="/hire-fractional-chro" className="text-gray-600 hover:text-emerald-700 transition-colors">Hire a Fractional CHRO</Link></li>
                  </ul>
                </div>
                {/* External Resources */}
                <div>
