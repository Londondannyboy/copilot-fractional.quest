...
export default function FractionalCISOServicesPage() {
  return (
    <div className="min-h-screen bg-white">
      <WebPageSchema title="Fractional CISO Services UK | Part-Time Security Leadership" description="Get experienced CISO leadership without full-time commitment." url="https://fractional.quest/fractional-ciso-services" dateModified={new Date('2026-01-08')} />
