...
export function FintechRecruitmentAgencyClient() {
      ...
      <section className="py-12 sm:py-16 bg-white border-t">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            ...
            <Link href="/fractional-recruitment-agency" className="bg-gray-50 p-4 sm:p-6 rounded-lg border hover:border-emerald-500 hover:shadow-md transition-all text-center"><div className="text-2xl sm:text-3xl mb-2">🎯</div><div className="font-medium text-gray-900 text-sm sm:text-base">Fractional Recruitment</div></Link>
          </div>
        </div>
      </section>
  ...
  return (
    <main>
      <LazyCopilotSidebar instructions={`## PAGE CONTEXT\nPage Type: guide | Topic: Fintech Recruitment Agencies | URL: /fintech-recruitment-agency\n\nYou're helping someone understand fintech recruitment agencies and how to hire fintech talent.\nKey facts: Fintech recruiter fees 18-28% | 3-5 weeks average | Domain expertise critical | FCA/regulatory knowledge important`} labels={{ title: "Fintech Hiring Guide", initial: firstName ? `Hi ${firstName}! I can help you find the right fintech recruitment agency or candidate.` : `Welcome! This guide covers fintech recruitment agencies and financial technology hiring.` }}>
        {pageContent}
      </LazyCopilotSidebar>
    </main>
  );
