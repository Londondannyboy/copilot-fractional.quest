...
// MIGRATION COMPLETE: All pages now served from Neon via IntelligentPageRenderer
// Hardcoded page.tsx files still exist but [slug] route takes priority for pages in Neon
// Keep this list empty - only add back if specific pages need static handling
const STATIC_ROUTE_SLUGS: string[] = []
...
export default async function DynamicPage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      {/* Page Content - Always use IntelligentPageRenderer for rich layout */}
      {/* MDX content stays in DB for CopilotKit/AI, sections JSON is rendered visually */}
