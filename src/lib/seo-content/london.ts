...
export const londonSEO = {
  ...
  statistics: {
    marketGrowth: {
      value: "300%",
      description: "Growth in fractional executive appointments since 2020",
      source: "McKinsey & Company / BBC Business",
    },
    londonConcentration: {
      value: "70%",
      description: "Of UK high-growth companies using fractional leadership are London-based",
      source: "ScaleUp Institute Annual Report",
    },
    hybridArrangements: {
      value: "65%",
      description: "Of London fractional roles offer hybrid working arrangements",
      source: "CIPD Flexible Working Survey 2024",
    },
    averageDayRate: {
      value: "£1,150",
      description: "Average day rate for fractional executives in London",
      source: "Fractional Quest Market Analysis",
    },
    costSavings: {
      value: "40-60%",
      description: "Typical savings vs full-time executive hire",
      source: "British Business Bank SME Report",
    },
  },
      ...
      areas: [
        {
          ...
          description:
            "The traditional financial heart of London. High demand for fractional CFOs serving fintech disruptors (Revolut, Monzo, Starling), legal tech, and professional services firms. Day rates premium: +15-20%.",
          sectors: ["Fintech", "Legal", "Professional Services", "Insurance"],
        },
        {
          name: "Canary Wharf & Docklands",
          description:
            "Major banks, asset managers, and increasingly tech firms. Growing demand for digital transformation CTOs and fractional CISOs. Strong compliance and regulatory expertise required.",
          sectors: ["Banking", "Asset Management", "RegTech", "PropTech"],
        },
        {
          name: "Shoreditch & Tech City",
          description:
            "London's startup epicentre. High demand for fractional CTOs, CPOs, and CMOs comfortable with early-stage, high-growth environments. More equity-inclusive arrangements common.",
          sectors: ["SaaS", "D2C", "Marketplaces", "AI/ML"],
        },
        {
          name: "King's Cross & Camden",
          description:
            "Home to Google, Meta's UK HQ, and a growing cluster of scale-ups. Demand for experienced operators who can bridge startup agility with enterprise scale.",
          sectors: ["Big Tech", "Scale-ups", "Media", "Creative"],
        },
      ],
    },
